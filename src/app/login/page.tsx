      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 text-center">
            <p className="text-xs text-gray-400">New advocate? Contact your administrator to set up access.</p>
          </div>
        </div>
        <p className="text-center text-xs text-gray-400 mt-6">© 2025 LexLedger Pro · Secure Multi-tenant Platform</p>
      </div>
    </div>
  )
}
